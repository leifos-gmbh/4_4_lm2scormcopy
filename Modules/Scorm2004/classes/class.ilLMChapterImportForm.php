...
class ilLMChapterImportForm
{
	...
	function getHTML()
	{
		...
		$this->list->addListNode(
			ilUtil::img(ilUtil::getImagePath("icon_".$this->current_parent["type"].".png"))." ".
	...
	function addNode($a_node, $a_parent, $a_depth)
	{
		...
		if (!$this->confirm)
		{
			$sel = ($a_node["type"] != "pg")
				...
				: "";
			$img = ilUtil::img(ilUtil::getImagePath("icon_".$a_node["type"].".png"));
		}
		else
		{
...
//echo "<br>-".$a_node["title"]."-".$parent_type."-";
			$img = ilUtil::img(ilUtil::getImagePath("icon_".$ctype.".png"));
